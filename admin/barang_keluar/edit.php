...
$idk = $_GET["id"];
    $data=query("SELECT * FROM stok_keluar WHERE id='$idk' ");
...
<div class="card card-stock-barang" style="width: 50%; background-color: #EEEEEE;">
    ...
    <div class="col-12">
        <input type="hidden" class="form-control" id="inputAddress" placeholder="Jukuna..." name="idk" value="<?php echo $idk ?>">
    </div>
    <div class="col-12">
        <input type="hidden" class="form-control" id="inputAddress" placeholder="Jukuna..." name="idkain" value="<?php echo $idkain ?>" >
    </div>
    <div class="col-12">
        <label for="inputAddress2" class="form-label">Jumlah</label>
        <input type="text" class="form-control" id="inputAddress3" placeholder="Besar" name="jlh" value="<?php echo $jlh ?>">
    </div>
    <div class="col-12">
        <label for="inputAddress2" class="form-label">Satuan</label>
        <input type="text" class="form-control" id="inputAddress4" placeholder="2" name="satuan" value="<?php echo $sat ?>">
    </div>
