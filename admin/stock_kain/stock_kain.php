...
<div class="content-wrapper" style="background-color: #BBBBBB;">
    ...
    <!-- Isi konten -->
        <div class="container-fluid">
            ...
            <!-- cek jika stock barang kosong atau tidak -->
            ...
            <table class="table-admin table table-secondary table-hover">
                ...
                <?php foreach($data AS $baris):?>
                    <tr>
                        ...
                        <td><?php echo $baris['nama_kain'];?></</td>
                        <td><?php echo $baris['stok'];?></td>
                        <td><?php echo $baris['satuan'];?></td>
                        <td style="display: flex; justify-content: space-around;">
                            <a href="./edit.php?id=<?php echo $baris["idkain"];?>">
                                <button type="button" class="btn btn-warning">Edit</button>
                            </a>
                            <a href="./hapus.php?id=<?php echo $baris["idkain"];?>">
