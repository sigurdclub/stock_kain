    ...
    <div class="card-body">
        <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="inputAddress" placeholder="Jukuna..." name="nama_kain" >
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Satuan</label>
                <input type="text" class="form-control" id="inputAddress3" placeholder="Besar" name="satuan">
            </div>
            <!-- <div class="col-12">
