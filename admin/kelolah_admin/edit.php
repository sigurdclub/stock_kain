...
<aside class="main-sidebar elevation-4" style="background-color: #1F1D36;">
    ...
    <h4 class="brand-text font-weight-light" style="text-align: center;">Admin</h4>
    </a>
...
<div class="card card-stock-barang" style="width: 50%; background-color: #EEEEEE;">
    ...
    <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12">
            ...
            <input type="text" class="form-control" id="inputAddress" placeholder="Jukuna..." name="username"value="<?php echo $nama ?>" >
        </div>
        <div class="col-12">
            <label for="inputAddress" class="form-label">Password</label>
            <input type="password" class="form-control" id="inputAddress" placeholder="Jukuna..." name="password"value="<?php echo $pwd ?>" >
        </div>
